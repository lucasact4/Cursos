...
public class TaskController {
	...
	public void save(Task task) {
		...
		String sql = "INSERT INTO tasks (project_id, name, description, completed, notes, deadline, createdAt, updatedAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public void update(Task task) {
		...
		String sql = "UPDATE tasks SET project_id = ?, name = ?, description = ?, completed = ?, notes = ?, deadline = ?, createdAt = ?, updatedAt = ? WHERE id = ?";
