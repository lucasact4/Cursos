CREATE DATABASE  IF NOT EXISTS `teste2` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `teste2`;
...
INSERT INTO `empregado` VALUES (1,20),(2,30),(3,22),(4,26),(5,21);
...
CREATE TABLE `pagamento` (
  `empregado_id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `pagamento` VALUES (1,'2002-07-08',1000),(2,'2002-07-08',2000),(3,'2002-07-08',1400),(4,'2002-07-08',1200),(5,'2002-07-08',5000);
...
-- Dump completed on 2023-01-05  4:24:56
...
-- Dump completed on 2023-01-05  4:24:57
...
INSERT INTO `departamento` VALUES (1,'Informática'),(2,'Finanças'),(3,'Pessoal'),(4,'Pagamento'),(5,'Administração');
...
LOCK TABLES `empregado` WRITE;
/*!40000 ALTER TABLE `empregado` DISABLE KEYS */;
INSERT INTO `empregado` VALUES (1,1000,2),(2,1250,4),(3,2500,1),(4,3900,3);
/*!40000 ALTER TABLE `empregado` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
