...
class ChefsLoginTest < ActionDispatch::IntegrationTest
  ...
  test "invalid login is rejected" do
    ...
    assert_redirected_to login_path # Verifica se houve redirecionamento para a rota de login
    follow_redirect! # Segue a redireção
    assert_template 'sessions/new' # Verifica se o template correto é renderizado
